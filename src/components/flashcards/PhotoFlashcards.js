				...
				<ReactCardFlip isFlipped={this.state.isFlipped} flipDirection="horizontal">
					<div className="pfc-card" key="front">
						...
						<div className="row">
							...
							<button className="pfc-btn" onClick={this.handleFButton} id="but3" value={randomArray[3]}>
								{randomArray[3]}
							</button>
						</div>
					</div>
...
export default compose(
	...
	firestoreConnect([ { collection: 'flashcards' }, { collection: 'decks' }, { collection: 'users' } ]),
	connect((state, props) => ({
