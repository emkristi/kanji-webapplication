			...
			<div className="container center">
				<ReactCardFlip isFlipped={this.state.isFlipped} flipDirection="horizontal">
					<div className="pfc-card" key="front">
						...
						<div className="row">
							<button className="pfc-btn" onClick={this.handleFButton} id="but1" value={randomArray[0]}>
								{randomArray[0]}
							</button>
							<button className="pfc-btn" onClick={this.handleFButton} id="but2" value={randomArray[1]}>
								{randomArray[1]}
							</button>
							<button className="pfc-btn" onClick={this.handleFButton} id="but3" value={randomArray[2]}>
								{randomArray[2]}
							</button>
							<button className="pfc-btn" onClick={this.handleFButton} id="but4" value={randomArray[3]}>
								{randomArray[3]}
							</button>
						</div>
					</div>
					...
					<div className="pfc-card" key="back">
						...
						<br />
						<span className="card-title">{personalmnemonic && <span>{personalmnemonic}</span>}</span>
						...
						<div>
							<div onClick={this.handleEditMnemClick}>
						...
						<div className="pfbuttons">
							<button onClick={this.handleHard} id="Hard">
								Hard
							</button>
							<button onClick={this.handleEasy} id="Easy">
								Easy
							</button>
						</div>
					</div>
