					...
					<div className="col s12">
						<div className="info">
							...
							<div className="row">
								<div className="col s12 m6 l6">
									<h5>Stroke order</h5>
									Some flashcards in the application has stroke orders. A stroke order shows how to
									draw the Kanji. The gifs used in the application are made by ....
								...
								<div className="col s12 m6 l6 center-align">
									<img
										className="activator strokeorderimg"
										src="img/About-penstroke.png"
										alt="Stroke order"
									/>{' '}
								</div>
							</div>
